...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__cpu__DOT__branch_predictor__DOT__update_index = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__cpu__DOT__branch_predictor__DOT__predict_index = VL_RAND_RESET_I(5);
