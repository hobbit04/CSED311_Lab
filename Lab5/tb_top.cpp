...
int main(int argc, char** argv, char** env) {
    ...
    string filename = "./student_tb_Lab4/answer_basic.txt";
    // string filename = "./student_tb_Lab4/answer_ifelse.txt";
    // string filename = "./student_tb_Lab4/answer_loop.txt";
    // string filename = "./student_tb_Lab4/answer_non-controlflow.txt";

    // string filename = "./student_tb_Lab5/naive_ripes_result.txt";
    // string filename = "./student_tb_Lab5/opt_ripes_result.txt";
