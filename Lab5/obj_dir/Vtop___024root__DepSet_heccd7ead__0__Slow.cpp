...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__cpu__DOT__dmem__DOT__is_input_valid = VL_RAND_RESET_I(1);
    ...
    VL_RAND_RESET_W(128, vlSelf->top__DOT__cpu__DOT__dmem__DOT__din);
    vlSelf->top__DOT__cpu__DOT__dmem__DOT__is_output_valid = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(128, vlSelf->top__DOT__cpu__DOT__dmem__DOT__dout);
    vlSelf->top__DOT__cpu__DOT__dmem__DOT__mem_ready = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__dmem__DOT__i = VL_RAND_RESET_I(32);
    for (int __Vi0 = 0; __Vi0 < 16384; ++__Vi0) {
        VL_RAND_RESET_W(128, vlSelf->top__DOT__cpu__DOT__dmem__DOT__mem[__Vi0]);
    }
    vlSelf->top__DOT__cpu__DOT__dmem__DOT__delay_counter = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__cpu__DOT__dmem__DOT___mem_addr = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__cpu__DOT__dmem__DOT___mem_read = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__dmem__DOT___mem_write = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(128, vlSelf->top__DOT__cpu__DOT__dmem__DOT___din);
    vlSelf->top__DOT__cpu__DOT__dmem__DOT__request_arrived = VL_RAND_RESET_I(1);
