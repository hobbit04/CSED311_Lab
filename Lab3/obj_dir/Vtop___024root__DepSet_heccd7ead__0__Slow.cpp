...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__cpu__DOT__ALUControl = VL_RAND_RESET_I(6);
    ...
    vlSelf->top__DOT__cpu__DOT__alu_ctrl_unit__DOT__ALUControl = VL_RAND_RESET_I(6);
    vlSelf->top__DOT__cpu__DOT__alu__DOT__ALUControl = VL_RAND_RESET_I(6);
