...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ top__DOT__cpu__DOT__pc__DOT__PCWriteNotCond;
        ...
        CData/*0:0*/ top__DOT__cpu__DOT__ctrl_unit__DOT__state_to_control__DOT__PCWriteNotCond;
    ...
    struct {
        ...
        CData/*0:0*/ top__DOT__cpu__DOT__ctrl_unit__DOT__state_machine__DOT__alu_bcond;
        ...
        CData/*3:0*/ top__DOT__cpu__DOT__alu_ctrl_unit__DOT__ALUControl;
        CData/*3:0*/ top__DOT__cpu__DOT__alu__DOT__ALUControl;
