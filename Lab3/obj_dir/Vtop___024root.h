...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*4:0*/ top__DOT__cpu__DOT__ALUControl;
    ...
    struct {
        ...
        CData/*4:0*/ top__DOT__cpu__DOT__alu_ctrl_unit__DOT__ALUControl;
        CData/*4:0*/ top__DOT__cpu__DOT__alu__DOT__ALUControl;
