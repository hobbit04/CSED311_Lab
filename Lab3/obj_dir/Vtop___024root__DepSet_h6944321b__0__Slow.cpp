...
VL_ATTR_COLD void Vtop___024root___stl_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.top__DOT__cpu__DOT__PCWriteNotCond = 
        Vtop__ConstPool__TABLE_hb422b802_0[__Vtableidx1];
    vlSelfRef.top__DOT__cpu__DOT__PCWrite = Vtop__ConstPool__TABLE_h1f28d3f6_0
        [__Vtableidx1];
    ...
    vlSelfRef.top__DOT__cpu__DOT__IRWrite = Vtop__ConstPool__TABLE_hfb65ae0a_0
        [__Vtableidx1];
    vlSelfRef.top__DOT__cpu__DOT__PCSource = Vtop__ConstPool__TABLE_hb422b802_0
        [__Vtableidx1];
    vlSelfRef.top__DOT__cpu__DOT__ALUOp = Vtop__ConstPool__TABLE_hcf0c8207_0
        [__Vtableidx1];
    vlSelfRef.top__DOT__cpu__DOT__ALUSrcB = Vtop__ConstPool__TABLE_h090d42d5_0
        [__Vtableidx1];
    vlSelfRef.top__DOT__cpu__DOT__ALUSrcA = Vtop__ConstPool__TABLE_hd41f12f7_0
        [__Vtableidx1];
    ...
    vlSelfRef.top__DOT__cpu__DOT__pc__DOT__PCWriteNotCond 
        = vlSelfRef.top__DOT__cpu__DOT__PCWriteNotCond;
    vlSelfRef.top__DOT__cpu__DOT__ctrl_unit__DOT__PCWriteNotCond 
        = vlSelfRef.top__DOT__cpu__DOT__PCWriteNotCond;
    ...
    vlSelfRef.top__DOT__cpu__DOT__ctrl_unit__DOT__ALUOp 
        = vlSelfRef.top__DOT__cpu__DOT__ALUOp;
    if ((0U == (IData)(vlSelfRef.top__DOT__cpu__DOT__ALUOp))) {
        vlSelfRef.top__DOT__cpu__DOT__ALUControl = 0U;
    } else if ((1U == (IData)(vlSelfRef.top__DOT__cpu__DOT__ALUOp))) {
        vlSelfRef.top__DOT__cpu__DOT__ALUControl = 
            ((4U & (IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs))
              ? ((2U & (IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs))
                  ? 0U : ((1U & (IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs))
                           ? 7U : 6U)) : ((2U & (IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs))
                                           ? 0U : (
                                                   (1U 
                                                    & (IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs))
                                                    ? 3U
                                                    : 2U)));
    } else if ((2U == (IData)(vlSelfRef.top__DOT__cpu__DOT__ALUOp))) {
        if ((4U & (IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs))) {
            vlSelfRef.top__DOT__cpu__DOT__ALUControl 
                = ((2U & (IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs))
                    ? ((1U & (IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs))
                        ? 4U : 5U) : ((1U & (IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs))
                                       ? ((8U & (IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs))
                                           ? 0xdU : 0xbU)
                                       : 8U));
        } else if ((1U & (~ ((IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs) 
                             >> 1U)))) {
            vlSelfRef.top__DOT__cpu__DOT__ALUControl 
                = ((1U & (IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs))
                    ? 0xaU : ((1U & ((0x13U == (IData)(vlSelfRef.top__DOT__cpu__DOT__imm_gen__DOT__opcode)) 
                                     | (~ ((IData)(top__DOT__cpu__DOT____Vcellinp__alu_ctrl_unit__functs) 
                                           >> 3U))))
                               ? 0U : 1U));
        }
    ...
    vlSelfRef.top__DOT__cpu__DOT__ctrl_unit__DOT__state_to_control__DOT__IRWrite 
        = vlSelfRef.top__DOT__cpu__DOT__ctrl_unit__DOT__IRWrite;
    vlSelfRef.top__DOT__cpu__DOT__ctrl_unit__DOT__state_to_control__DOT__PCWriteNotCond 
        = vlSelfRef.top__DOT__cpu__DOT__ctrl_unit__DOT__PCWriteNotCond;
    ...
    if ((8U & (IData)(vlSelfRef.top__DOT__cpu__DOT__ALUControl))) {
        if ((4U & (IData)(vlSelfRef.top__DOT__cpu__DOT__ALUControl))) {
            if ((2U & (IData)(vlSelfRef.top__DOT__cpu__DOT__ALUControl))) {
        ...
        } else if ((2U & (IData)(vlSelfRef.top__DOT__cpu__DOT__ALUControl))) {
            vlSelfRef.top__DOT__cpu__DOT__alu_result 
    ...
    } else if ((4U & (IData)(vlSelfRef.top__DOT__cpu__DOT__ALUControl))) {
        if ((1U & (~ ((IData)(vlSelfRef.top__DOT__cpu__DOT__ALUControl) 
                      >> 1U)))) {
            vlSelfRef.top__DOT__cpu__DOT__alu_result 
                = ((1U & (IData)(vlSelfRef.top__DOT__cpu__DOT__ALUControl))
    ...
    vlSelfRef.top__DOT__cpu__DOT__alu__DOT__alu_bcond 
        = vlSelfRef.top__DOT__cpu__DOT__alu_bcond;
    vlSelfRef.top__DOT__cpu__DOT__ctrl_unit__DOT__alu_bcond 
        = vlSelfRef.top__DOT__cpu__DOT__alu_bcond;
    __Vtableidx2 = (((IData)(vlSelfRef.top__DOT__cpu__DOT__imm_gen__DOT__opcode) 
                     << 5U) | (((IData)(vlSelfRef.top__DOT__cpu__DOT__alu_bcond) 
    ...
    vlSelfRef.top__DOT__cpu__DOT__ctrl_unit__DOT__next_state 
        = Vtop__ConstPool__TABLE_hf9ccadec_0[__Vtableidx2];
    ...
    vlSelfRef.top__DOT__cpu__DOT__ctrl_unit__DOT__state_machine__DOT__alu_bcond 
        = vlSelfRef.top__DOT__cpu__DOT__ctrl_unit__DOT__alu_bcond;
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__cpu__DOT__ALUControl = VL_RAND_RESET_I(4);
    ...
    vlSelf->top__DOT__cpu__DOT__pc__DOT__PCWriteNotCond = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__cpu__DOT__ctrl_unit__DOT__state_to_control__DOT__PCWriteNotCond = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__cpu__DOT__ctrl_unit__DOT__state_machine__DOT__alu_bcond = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__cpu__DOT__alu_ctrl_unit__DOT__ALUControl = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__cpu__DOT__alu__DOT__ALUControl = VL_RAND_RESET_I(4);
