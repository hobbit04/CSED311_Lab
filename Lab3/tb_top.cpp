...
int main(int argc, char** argv, char** env) {
    ...
    // string filename = "/home/daniel/CSED311_Lab/Lab3/student_tb/answer_basic.txt";
    string filename = "/home/daniel/CSED311_Lab/Lab3/student_tb/answer_non-controlflow.txt";
